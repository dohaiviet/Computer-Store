                        ...
                        <div class="row">
                            ...
                            <form method="GET" action="cart.php">
                                ...
                                if(isset($_SESSION['user']))
                                {
                                    ...
                                    <div  class="font-weight-bold"><label style="margin-right: 5px; color:red;font-size: 14px";>Số lượng còn:</label><strong><?= $product['quantity'] ?></strong></div>
                                    <button class="nutmua btn w-100 text-uppercase" type="submit"> Thêm vào giỏ hàng</button>
                                    <?php } else { ?>
                                    <span class="nutmua btn w-100 text-uppercase"><a href="index.php"class="nutmua btn w-100 text-uppercase">Hết hàng</a></span>
                                    <?php } ?>
                                    <?php
                                }
                                 else
                            ...
                            <div class="col-md-5">
                                <div class="thongtinsach">
                                    <ul>
                                        ...
                                        <li><b>Miễn phí giao hàng </b>cho đơn hàng từ 1.500.000đ ở nội thành Hà Nội và 2.000.000đ ở
                                            Tỉnh/Thành khác</li>
