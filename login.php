         ...
         if(isset($_POST['username']))
         {
            ...
            //  die();
             ...
             else
             {
              ...
              <h3 style="margin-top: 16px; color: white;"><?= "Thông tin đăng nhập không chính xác. Vui lòng nhập lại ! " ?></h3>
               <?php
             }
         }
...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <form acton="./login.php" name="form1" class="box" onsubmit="return checkStuff()" method="Post" autocomplete="off">
      ...
      <h5>Vui lòng nhập thông tin đăng nhập</h5>
        ...
        <a href="register.php" class="dnthave">Đăng ký tài khoản mới</a>
  </div>
</div>
