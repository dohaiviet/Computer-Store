...
<section class="_1khoi sachmoi bg-white">
        <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 d-flex justify-content-between align-items-left pb-2 bg-transparent pt-4">
                        ...
                        <a href="tongsp.php" class="btn btn-xemtatca">Xem tất cả</a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="title-box">
            <h1 class="header text-uppercase" style="font-weight: 400;">LAPTOP GAMING, ĐỒ HỌA </h1>
            <div class="sub_cat_title">  
        ...
        <div class="container">
            ...
            <div class="sub_cat_title">  
                <a href="#">CPU - Bộ xử lý</a>
                <a href="#">Mainbroard - Bo mạch chủ</a>
                <a href="#">RAM - Bộ nhớ trong</a>
                <a href="#">Ổ cứng SSD</a>      
                <a href="#">Ổ đĩa quang - ODD</a> 
            </div>
            </div>
                <div class="khoisanpham" style="padding-bottom: 2rem;">
                <?php
