<div class="container">
                    <div id="carouselId" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item">
                                <a href="#"><img src="images/banner/banner5.png" class="img-fluid"
                                        style="height: 500px;"  width="1200px"  alt="Third slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="images/banner/banner6.png" class="img-fluid"
                                        style="height: 500px;"  width="1200px"  alt="Third slide"></a>
                            </div>
                            <div class="carousel-item">
                                <a href="#"><img src="images/banner/banner7.jpg" class="img-fluid"
                                        style="height: 500px;"  width="1200px"  alt="Third slide"></a>
                            </div>
                        </div>
