...
<section class="content my-4">   
        <div class="container">
            ...
            <select id="sort-box" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                ...
                <option <?php if(isset($_GET['sort']) && $_GET['sort'] == "desc")  ?> value="?<?=$sortParam?>field=price&sort=desc">Giá giảm dần</option>

                <option <?php if(isset($_GET['sort']) && $_GET['sort'] == "asc")  ?> value="?<?=$sortParam?>field=price&sort=asc">Giá tăng dần</option>
                
                <option <?php if(isset($_GET['sort']) && $_GET['sort'] == "asc")  ?> value="?<?=$sortParam?>field=name&sort=asc">Tên từ A - Z</option>

                <option <?php if(isset($_GET['sort']) && $_GET['sort'] == "desc")  ?> value="?<?=$sortParam?>field=name&sort=desc">Tên từ Z - A</option>
